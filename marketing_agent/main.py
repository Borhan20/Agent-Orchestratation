...
def main(host: str, port: int):
    ...
    skill = AgentSkill(
        id='MarketingSkill',
        name='Can Determine Profit or Loss',
        description="Can provide decision of profit, or loss based on given inputs.",
        tags=['marketing'],
        examples=['is -20 profit or loss?', 'is 30 profit or loss?'],
    )

    agent_card = AgentCard(
        name='Marketing Agent (Simulated)',
        description="An agent that can give decision on profit or loss based on given inputs.",
